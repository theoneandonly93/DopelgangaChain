...
export default function DocsLayout({ children }: { children: ReactNode }) {
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-6 md:px-10 py-6 sm:py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <aside className="block md:hidden col-span-1 mb-4">
          <details className="glass rounded-2xl p-4 border border-white/10">
            <summary className="cursor-pointer text-white/80 font-semibold mb-2">Navigation</summary>
